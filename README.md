...
- **Повнодіапазонні тональні режими**:
  ...
  - Газетний растр (Dots) — класичний газетний друк 45°.
  - Графічний растр (Graphic Dots) — лінійний растр для логотипів, артів та графіки.
  - Фото + Растр (Hybrid) — текстура растру поверх чорно-білої фотографії.
