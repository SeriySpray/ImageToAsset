...
- **Повнодіапазонні тональні режими**:
  - Фото-растр (Dots) — класичний газетний друк 45°.
  - Колір + Растр (Color Halftone) — збереження насичених кольорів фотографії з текстурою газетного растру.
  - Графічний растр (Graphic Dots) — лінійний растр для логотипів, артів та графіки на білому папері.
  - Паперовий растр (Paper Halftone) — графічний растр, де весь задній фон точно збігається з кольором та текстурою обвідки/підкладки.
